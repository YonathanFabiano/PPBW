                            ...
                            @csrf
                              ...
                              <div class="form-group w-25">
                                  ...
                                  <select name="jurusan" class="form-control">
                                      ...
                                      <option value="PT Hidayat Tbk">PT Hidayat Tbk</option>
                                      <option value="PT Samosir (Persero) Tbk">PT Samosir (Persero) Tbk</option>
                                      <option value="PT Tamba (Persero) Tbk">PT Tamba (Persero) Tbk</option>
                                      <option value="CV Kuswandari">CV Kuswandari</option>
                                      <option value="CV Hastuti (Persero) Tbk">CV Hastuti (Persero) Tbk</option>
                                      <option value="CV Mangunsong Padmasari">CV Mangunsong Padmasari</option>
                                      <option value="CV Suwarno (Persero) Tbk">CV Suwarno (Persero) Tbk</option>
                                      <option value="UD Manullang Tbk">UD Manullang Tbk</option>
                                      <option value="Perum Wasita">Perum Wasita</option>
                                  </select>
                              </div>
