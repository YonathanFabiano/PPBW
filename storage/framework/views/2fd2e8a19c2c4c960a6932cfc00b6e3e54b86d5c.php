                            ...
                            <tbody>
                                <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/user/edituser/<?php echo e($u -> id); ?>" class="btn btn-outline-success"><i class="bi bi-pencil-square"></i></a>
                                            <a href="/user/hapususer/<?php echo e($u -> id); ?>" class="btn btn-outline-danger"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
...
<?php /**PATH D:\Application\teori13\resources\views/user.blade.php ENDPATH**/ ?>